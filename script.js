document.addEventListener('keydown', (event) => {
	...
	if(key == 65) {
		...
		audio.currentTime = 0;
		audio.play();
		document.getElementById('65').style.backgroundColor = "#ff00ff";
		document.getElementById('65').style.boxShadow = "0px 0px 20px 0px 3ff00ff";
		setTimeout(function() {
	...
	if(key == 75) {
		var audio = new Audio("Alan2.mp3");
		audio.currentTime = 0;
		audio.play();
		document.getElementById('75').style.backgroundColor = "aqua";
	...
	if(key == 76) {
		var audio = new Audio("Alan3.mp3");
		audio.currentTime = 0;
		audio.play();
		document.getElementById('76').style.backgroundColor = "#ff00ff"
		document.getElementById('76').style.boxShadow = "0px 0px 20px 0px #ff00ff";
		setTimeout(function() {
